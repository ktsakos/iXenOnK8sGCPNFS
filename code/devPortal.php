...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background-color: DodgerBlue!important;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="Sub.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Available Platform Sensors</a>
    <a href="createApp.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Create Applications</a>
    <a href="editapp.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Edit Applications</a>
    <a href="Myapp.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">My Applications</a>
    <a href="MySensors.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">My Subscriptions to Sensors</a>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Developer Hub</b></h1>
  </div>
  ...
  <div class="w3-container" id="services" style="margin-top:75px;">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Available Platform Sensors.</b></h1>
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Create Applications.</b></h1>
    <hr style="width:50px;border:5px solid DodgerBlue" class="w3-round">
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>Edit Applications.</b></h1>
    <hr style="width:50px;border:5px solid DodgerBlue" class="w3-round">
    <p>The best team in the world.</p>
    <p>We are lorem ipsum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
    dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"style="color: DodgerBlue!important;"><b>My Subscriptions to Sensors.</b></h1>
    <hr style="width:50px;border:5px solid DodgerBlue" class="w3-round">
    <p>The best team in the world.</p>
    <p>We are lorem ipsum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
    dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor
